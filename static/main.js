...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar addCommentForm = document.getElementById(\"jsAddComment\");\nvar commentList = document.getElementById(\"jsCommentList\");\nvar commentNumber = document.getElementById(\"jsCommentNumber\");\n\nvar decreaseNumber = function decreaseNumber() {\n  commentNumber.innerHTML = parseInt(commentNumber.innerHTML, 10) - 1;\n};\n\nvar deleteCommentHtml = function deleteCommentHtml(id) {\n  var el = document.querySelector(\"[data-comment-id=\\\"\".concat(id, \"\\\"]\"));\n  el.parentNode.removeChild(el);\n};\n\nvar handleDelete =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(e) {\n    var commentId, videoId, lastHash, response;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            if (!e.target.matches(\"#jsDeleteComment\")) {\n              _context.next = 16;\n              break;\n            }\n\n            commentId = e.target.parentElement.dataset.commentId;\n            videoId = window.location.href.split(\"/videos/\")[1];\n            lastHash = \"#\";\n\n            if (videoId.indexOf(lastHash) !== -1) {\n              videoId = videoId.replace(lastHash, \"\");\n            }\n\n            _context.prev = 5;\n            _context.next = 8;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(\"/api/\".concat(commentId, \"/comment/delete\"), {\n              id: commentId,\n              videoId: videoId\n            });\n\n          case 8:\n            response = _context.sent;\n            console.log(response);\n\n            if (response.status === 200) {\n              deleteCommentHtml(commentId);\n              decreaseNumber();\n            }\n\n            _context.next = 16;\n            break;\n\n          case 13:\n            _context.prev = 13;\n            _context.t0 = _context[\"catch\"](5);\n            console.log(_context.t0);\n\n          case 16:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, this, [[5, 13]]);\n  }));\n\n  return function handleDelete(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nfunction init() {\n  commentList.addEventListener(\"click\", handleDelete);\n}\n\nif (addCommentForm) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/deleteComment.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! C:\\Users\\이희영\\Desktop\\wetube\\assets\\js\\main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");

const videoContainer = document.getElementById("jsVideoPlay");
const videoPlayer = document.querySelector("#jsVideoPlay video");
...
const formatDate = seconds => {
  const secondsNumber = parseInt(seconds, 10); //뒤에 인자 10진수라고 적어주는 것
